...
module.exports = function() {
  ...
  utilObj.getApplicationEnv = function() {
    ...
    try {
      ...
      console.error("[Auto-Scaling Agent] Failed to parse process.env.VCAP_APPLICATION:" + process.env.VCAP_APPLICATION);
  ...
  utilObj.getServiceEnv = function() {
    ...
    try {
      ...
      console.error("[Auto-Scaling Agent] Failed to parse process.env.VCAP_SERVICES:" + process.env.VCAP_SERVICES);
      console.error("[Auto-Scaling Agent] Error:" + e);
      return null;
    }
  ...
  utilObj.parseUrlToHostPort = function(urlStr) {
    if (!urlStr) {
      console.error("[Auto-Scaling Agent] service url is null or undefined");
      return null;
    }
